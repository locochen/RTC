	...
	<script type="text/javascript">
		...
		function createPeerConnection() {
			var pc_config = {
				...
				} ]//stun:stun.1.google.com.com:19302 from https://code.google.com/p/natvpn/source/browse/trunk/stun_server_list
			};
			try {
		...
		function onChannelMessage(message) {
			...
			if (isRTCPeerConnection)
				processSignalingMessage(message.data);//video has been connected
			else
